...
//       },
    ...
    repo: 'my-monster/vdoing-demo', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'liuyuan', // 必需
      link: 'https://github.com/my-monster', // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      // avatar: 'https://cdn.jsdelivr.net/gh/xugaoyi/image_store/blog/20200103123203.jpg',
      avatar: '/img/myself.jpg',
      name: 'Liu Yuan',
      slogan: '热爱生活！',
    },
    ...
    social: {
      ...
      icons: [
        ...
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
          link: 'https://music.163.com/#/playlist?id=463807063',
        },
      ],
    },
